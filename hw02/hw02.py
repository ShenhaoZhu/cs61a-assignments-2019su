...
def make_repeater(f, n):
    ...
    "*** YOUR CODE HERE ***"
    g = f
    h = accumulate(compose1,lambda x: x, n, lambda i: f)
    return h
...
def count_change(amount):
    ...
    def helper(remain ,money):
        if remain == 0:
            ...
            return 0
        return helper(remain-money,money)+helper(remain,money*2)
